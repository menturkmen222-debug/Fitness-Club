...
export function Hero({ club }: { club: FitnessClub }) {
  ...
  return (
    <section className="relative min-h-screen flex items-center pt-24 pb-12 overflow-hidden bg-background">
      ...
      <div className="absolute bottom-[20%] left-[-10%] w-[500px] h-[500px] bg-primary/10 rounded-full blur-[100px] animate-blob pointer-events-none" style={{ animationDelay: '-5s' }} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-8 flex flex-col items-start text-left">
            ...
            <div className="hero-buttons flex flex-wrap items-center gap-4 w-full sm:w-auto">
              ...
              <a href="#services" className="w-full sm:w-auto px-8 py-4 bg-white/5 text-white font-bold uppercase tracking-wider rounded border border-white/10 hover:bg-white/10 transition-all text-center">
                Bahalar
              </a>
            </div>
            ...
            <div className="hero-buttons mt-10 flex items-center gap-4 text-sm text-muted-foreground">
              ...
              <span className="font-mono text-white">{club.members}+ Agza</span>
              <span className="w-1 h-1 rounded-full bg-white/20" />
              <span>{club.est}-nji ýyldan</span>
            </div>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground uppercase tracking-wide">Aktiw Agza</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground uppercase tracking-wide">Tälimçi</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="font-mono text-2xl text-white font-bold">{yearsExp} Ýyl</div>
                    <div className="text-sm text-muted-foreground uppercase tracking-wide">Tejribe</div>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div className="w-full bg-primary/10 border-y border-primary/20 py-8 relative z-20">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8 divide-x divide-primary/10 text-center">
        <div className="reveal">
          ...
          <div className="text-primary font-bold uppercase tracking-widest text-sm">Aktiw Agza</div>
        </div>
        <div className="reveal">
          <div className="font-mono text-4xl md:text-5xl font-bold text-white mb-2 text-shadow-glow">
            <Counter target={trainCount} suffix="+" />
          </div>
          <div className="text-primary font-bold uppercase tracking-widest text-sm">Hünärmen Tälimçi</div>
        </div>
        <div className="reveal">
          <div className="font-mono text-4xl md:text-5xl font-bold text-white mb-2 text-shadow-glow">
            <Counter target={yearsExp} />
          </div>
          <div className="text-primary font-bold uppercase tracking-widest text-sm">Ýyl Tejribe</div>
        </div>
        <div className="reveal">
          <div className="font-mono text-4xl md:text-5xl font-bold text-white mb-2 text-shadow-glow">24/7</div>
          <div className="text-primary font-bold uppercase tracking-widest text-sm">Açyk</div>
        </div>
      </div>
    </div>
  );
